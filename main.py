...
frined_pet1 = Pet("Friend Pet1", 20, 5, skill1, 1, 20, 500, 20, "resources\\images\\Pets\\pet00.png", 18)
frined_pet2 = Pet("Friend Pet2", 20, 5, skill2, 1, 20, 500, 20,  "resources\\images\\Pets\\pet01.png", 18)
